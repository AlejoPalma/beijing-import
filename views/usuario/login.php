<h1 class="my-4 h1 text-center">Iniciar sesión</h1>
...
<form id="form-login" action="<?= base_url ?>usuario/iniciar_sesion" method="POST">
    ...
    <div class="row mb-4 d-flex justify-content-center">
        ...
        <div class="col-sm-12 col-md-6 text-center">
            ...
            <button class="btn btn-primary mb-4 g-recaptcha" data-sitekey="6LdVWtcfAAAAAEWGQOAz5kyyTwngOp59_DXJLGgI" data-callback='onSubmit' data-action='submit'>
                Entrar
            </button>
            </br>
